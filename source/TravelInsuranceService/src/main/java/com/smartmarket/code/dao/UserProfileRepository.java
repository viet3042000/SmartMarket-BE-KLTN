...
//    public int updateUserProfileKafka(@Param("user_name") String userName,@Param("email") String email, @Param("gender") int gender,
//                                      @Param("enabled") int enabled,@Param("id") Long id,@Param("phone_number") String phoneNumber,
