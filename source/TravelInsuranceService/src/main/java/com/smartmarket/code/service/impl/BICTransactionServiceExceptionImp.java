...
//                }
    ...
    @Override
    public PendingBICTransaction createPendingBICTransactionFromRequest(HttpServletRequest request, String resultCode, String bicResultCode) {
        //add BICTransaction
...
//                    destroy =  createTravelInsuranceBICRequest.getTrv().getDestroy() ;
                ...
                try{
                    ...
                    clientIp = Utils.getClientIp(request) ;
                    pendingBICTransaction = bicTransactionService.createPendingBICTransactionParameter("Format not True", orderReference, orderId, customerName,
                            phoneNumber, email, ordPaidMoney, consumerId,
                            fromDate, toDate, new Date(), resultCode, bicResultCode,
                            ordDate, productId, customerAddress,clientIp,type,destroy);
...
//                    ordPaidMoney = createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney() == null ? null : createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney().toString();
                    ...
                    pendingBICTransaction = bicTransactionService.createPendingBICTransactionParameter(messasgeId, orderReference, orderId, customerName,
                            phoneNumber, email, ordPaidMoney, consumerId,
                            fromDate, toDate, new Date(), resultCode, bicResultCode,
                            ordDate, productId, customerAddress,clientIp,type,destroy);
                }
...
//                    ordPaidMoney = createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney() == null ? null : createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney().toString();
    ...
    public PendingBICTransaction createPendingBICTransactionFromRequestCreate(BaseDetail<CreateTravelInsuranceBICRequest> requestCreateTravelInsuranceBICRequest, String resultCode, String bicResultCode, String clientId){
        //add BICTransaction
        PendingBICTransaction pendingBICTransaction = null ;
        Optional<Client> client = clientService.findByclientName(clientId);
...
//                    ordPaidMoney = createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney() == null ? null : createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney().toString();
            ...
            pendingBICTransaction = bicTransactionService.createPendingBICTransactionParameterOutbox(messasgeId, orderReference, orderId, customerName,
                    phoneNumber, email, ordPaidMoney, consumerId,
                    fromDate, toDate, new Date(), resultCode, bicResultCode,
                    ordDate, productId, customerAddress,clientIp,type,destroy,clientId);
        }
...
//                    ordPaidMoney = createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney() == null ? null : createTravelInsuranceBICRequest.getOrders().getOrdPaidMoney().toString();
    ...
    public PendingBICTransaction createPendingBICTransactionFromRequestUpdate(BaseDetail<UpdateTravelInsuranceBICRequest> requestUpdateTravelInsuranceBICRequest, String resultCode, String bicResultCode, String clientId){
        //add BICTransaction
        PendingBICTransaction pendingBICTransaction = null ;
        Optional<Client> client = clientService.findByclientName(clientId);
