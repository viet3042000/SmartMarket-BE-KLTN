...
public interface ProductRepository extends JpaRepository<Product, String> {
    ...
    @Query(value = "select product_name from product where id =:id",nativeQuery = true)
    public String getProductName(@Param("id") Long id);

    @Query(value = "Update product_name from product where id =:id",nativeQuery = true)
    public String updateProductName(@Param("id") Long id);
