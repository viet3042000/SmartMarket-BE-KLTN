...
//        System.out.println("start : " + startTimeBeanProvider.startTime);
    ...
    public String test(@Valid @RequestBody BaseDetail<CreateTravelInsuranceBICRequest> createTravelInsuranceBICRequestBaseDetail, HttpServletRequest request, HttpServletResponse responseSelvet) throws JsonProcessingException, APIAccessException {
        return travelInsuranceService.test(createTravelInsuranceBICRequestBaseDetail, request, responseSelvet);
    }
