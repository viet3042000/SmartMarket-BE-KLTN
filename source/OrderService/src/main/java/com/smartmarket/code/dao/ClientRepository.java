...
//	public Object[] findByclientName2(@Param("clientId") String clientId);
	...
	public int updateClientKafka(@Param("id") Long id, @Param("clientId") String clientId,
	...
	public int deleteClientKafka(@Param("clientId") String clientId) ;

	@Modifying(clearAutomatically = true)
	@Query(value = "TRUNCATE TABLE clients",  nativeQuery = true)
	public int truncateClientKafka() ;
}